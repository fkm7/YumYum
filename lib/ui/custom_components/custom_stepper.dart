...
class _CustomStepperState extends State<CustomStepper> with TickerProviderStateMixin {
  ...
  Color _circleColor(int index) {
    ...
    // if (!_isDark()) {
    return widget.steps[index].isActive ? AppColors.green : AppColors.grey;
    // } else {
    ...
    return Container(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          shape: BoxShape.circle,
          boxShadow: widget.steps[index].isActive ? kElevationToShadow[9] : null,
        ),
        child: Center(
          ...
          children: <Widget>[
            TextButton(
              ...
              style: ButtonStyle(
                ...
                padding:
                    const MaterialStatePropertyAll<EdgeInsetsGeometry>(buttonPadding),
    ...
    return Stack(
      children: <Widget>[
        ...
        AnimatedCrossFade(
          ...
          sizeCurve: Curves.fastOutSlowIn,
          crossFadeState:
              _isCurrent(index) ? CrossFadeState.showSecond : CrossFadeState.showFirst,
          duration: kThemeAnimationDuration,
        ),
      ],
    );
          ...
          child: ListView(
            ...
            children: <Widget>[
              AnimatedSize(
                ...
                duration: kThemeAnimationDuration,
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch, children: stepPanels,),
              ),
